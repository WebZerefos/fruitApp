export const data: Fruit[] = [
	{
		...
		image: 'https://pngimg.com/d/blueberries_PNG39.png',
		gradientColors: ['#cececece', '#fa3e3e'],
		description: `Blueberries are perennial flowering plants with blue or purple berries. They are classified in the section Cyanococcus within the genus Vaccinium. Vaccinium also includes cranberries, bilberries, huckleberries and Madeira blueberries.
	...
	},
	{
		...
		title: 'Strawberry',
		headline:
			'Widely appreciated for its characteristic aroma,  red color, juicy texture, and sweetness.',
		image:
			'https://static.vecteezy.com/system/resources/previews/008/848/372/original/fresh-red-strawberry-fruit-free-png.png',
		gradientColors: ['#cececece', '#fa3e3e'],
		description: `The garden strawberry (or simply strawberry; Fragaria vs ananassa) is a widely grown hybrid species of the genus Fragaria, collectively known as the strawberries, which are cultivated worldwide for their fruit. The fruit is widely appreciated for its characteristic aroma, bright red color, juicy texture, and sweetness. It is consumed in large quantities, either fresh or in such prepared foods as jam, juice, pies, ice cream, milkshakes, and chocolates. Artificial strawberry flavorings and aromas are also widely used in products such as candy, soap, lip gloss, perfume, and many others.
	...
	},
	{
		...
		title: 'Lemon',
		headline:
			"There's no doubt lemons are delicious, but does adding them to water make you healthier?",
		image:
	...
	},
	{
		...
		title: 'Plum',
		headline:
			'Plums are a very nutritious fruit. An excellent source of vitamins, minerals, fiber and antioxidants.',
		image: 'https://freepngimg.com/thumb/plum/2-2-plum-png-images.png',
		gradientColors: ['#cececece', '#fa3e3e'],
	...
	},
	{
		...
		title: 'Lime',
		headline:
			'Sour, round, and bright green citrus fruits. Limes are high in vitamin C, antioxidants, and other nutrients.',
		image:
			'https://purepng.com/public/uploads/large/purepng.com-limelimelemonhybrid-citrus-fruitroundlime-greenpersian-lime-1701527330376zwxih.png',
		gradientColors: ['#cececece', '#fa3e3e'],
		description: ` A lime (from French lime, from Arabic līma, from Persian līmū, "lemon")[1] is a citrus fruit, which is typically round, green in color, 3 or 6 centimetres (1.2 or  2.4 in) in diameter, and contains acidic juice vesicles.
	...
	},
	{
		...
		image: 'https://parspng.com/wp-content/uploads/2021/12/pomegranate-png.parspng.com-11.png',
		gradientColors: ['#cececece', '#fa3e3e'],
	...
	},
	{
		...
		headline:
			'Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.',
		image: 'https://freepngimg.com/save/22189-yellow-pear/510x510',
		gradientColors: ['#cececece', '#fa3e3e'],
	...
	},
	{
		...
		headline:
			'Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.',
		image: 'https://www.pngmart.com/files/8/Mango-PNG-Image-Free-Download.png',
		gradientColors: ['#cececece', '#fa3e3e'],
	...
	},
	{
		...
		headline:
			'Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.',
		image:
			'https://www.freepnglogos.com/uploads/watermelon-png/download-watermelon-png-transparent-image-and-clipart-12.png',
		gradientColors: ['#cececece', '#fa3e3e'],
	...
	},
	{
		...
		headline:
			'Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.',
		image:
			'https://www.freepnglogos.com/uploads/cherry-png/cherry-harvest-schedule-brecknock-orchard-mohnton-34.png',
		gradientColors: ['#cececece', '#fa3e3e'],
	...
	},
	{
		...
		headline:
			'Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.',
		image: 'https://www.pngplay.com/wp-content/uploads/2/Grapefruit-PNG-Images-HD.png',
		gradientColors: ['#cececece', '#fa3e3e'],
	...
	},
	{
		...
		title: 'Apple',
		headline:
			'Apples are one of the most popular, and exceptionally healthy fruit for good reason.',
		image: 'https://pngimg.com/d/apple_PNG12405.png',
		gradientColors: ['#cececece', '#fa3e3e'],
